...
if ($payment_success) {
    ...
    $sql = "INSERT INTO `info_order` (`plant`, `price`, `quantity`, `total_amount`, `address`, `email`, `phone`, `dt`,`status`)
            VALUES ('$plant_name', $plant_price, $quantity, $total_amount, '$address', '$email', '$mobile', current_timestamp(),'pending')";
